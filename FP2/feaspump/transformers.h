...
inline double getRoundingThreshold(bool isRandom, dominiqs::UnitRandGen& gen)
{
	if (isRandom)
	{
...
public:
	SimpleRounding();
	void readConfig();
	void init(const dominiqs::Model& model, bool ignoreGeneralInt = true);
