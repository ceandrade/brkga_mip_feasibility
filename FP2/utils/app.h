...
public:
	...
	virtual ~App() {}
	/**
	 * @brief add a shortcut to the shortcut map for command line configuration overrides
	 */
	void addShortcut(const std::string& shortName, const std::string& fullName);
	/**
